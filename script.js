...
const translations = {
  fr: {
    ...
    hero_title: "Outils, Automation, High Tech & IA",
    ...
    p_ytdl: "Un seul bouton ajouté directement sur la page YouTube pour tout télécharger.<br><br>🎯 <b>Formats supportés :</b> MP4, MKV, WebM, MP3, FLAC, WAV, AAC, M4A, Opus, OGG<br>🎬 Jusqu'à 8K &nbsp; 💬 Sous-titres &nbsp; 🖼️ Miniatures &nbsp; 📋 Métadonnées",
  ...
  en: {
    ...
    hero_title: "Tools, Automation, High Tech & AI",
    ...
    title_ytdl: "YT Downloader",
    p_ytdl: "A single button added directly on the YouTube page to download everything.<br><br>🎯 <b>Supported formats:</b> MP4, MKV, WebM, MP3, FLAC, WAV, AAC, M4A, Opus, OGG<br>🎬 Up to 8K &nbsp; 💬 Subtitles &nbsp; 🖼️ Thumbnails &nbsp; 📋 Metadata",
